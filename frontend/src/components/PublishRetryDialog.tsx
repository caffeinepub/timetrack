    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            This will trigger a publish restart. Ensure all pre-publish verification steps are completed.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-4">
          <div className="p-4 bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800 rounded-lg">
            ...
            <p className="text-xs text-amber-800 dark:text-amber-200 mb-3">
              Before restarting the publish workflow, you must complete the Android regression checklist to verify that all icon-based controls work correctly on Android Chrome.
            </p>
            <Button
              variant="outline"
              size="sm"
          ...
          <div className="flex items-start space-x-3 p-3 bg-muted rounded-lg">
            ...
            >
              I confirm that I have completed the Android regression checklist and verified that all icon-based controls work correctly on Android Chrome without DOMException errors.
            </Label>
          </div>
        </div>
        <DialogFooter>
