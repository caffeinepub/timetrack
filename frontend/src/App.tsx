...
function AppContent() {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      await saveProfile.mutateAsync({ name: profileName.trim(), email: profileEmail.trim() });
    } catch (error) {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4">
        ...
        <div className="text-center max-w-md w-full">
          <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-primary">Suivi du Temps</h1>
          ...
          <div className="mt-8 p-4 sm:p-6 bg-card rounded-lg shadow-lg border">
            <h2 className="text-base sm:text-lg font-semibold mb-3">Fonctionnalités</h2>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background pb-safe overflow-x-hidden">
      ...
      <Dialog open={showProfileSetup} onOpenChange={() => {}}>
        ...
        >
          <DialogHeader>
            <DialogTitle className="text-lg sm:text-xl">Configuration du profil</DialogTitle>
