...
const interactionHistory: Array<{ timestamp: number; component: string; message: string }> = [];
...
export function getInteractionHistory(): Array<{ timestamp: number; component: string; message: string }> {
